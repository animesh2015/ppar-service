...
public class RGISResponse   {
  ...
  public RGISResponse returnCode(String returnCode) {
  ...
  @Size(max=1)   public String getReturnCode() {
    return returnCode;
  }
  ...
  public RGISResponse anyIdNo(String anyIdNo) {
  ...
  public RGISResponse referenceNo(String referenceNo) {
   ...
   * @return referenceNo
   **/
  @Schema(example = "010124000181", description = "")
      @NotNull
  ...
  public RGISResponse date(String date) {
    this.date = date;
    return this;
  }
   ...
   * @return date
   **/
  @Schema(example = "20240528", description = "YYYYMMDD")
      @NotNull
  ...
  public RGISResponse time(String time) {
    this.time = time;
    return this;
  }
   ...
   * @return time
   **/
  @Schema(example = "101127", description = "24HHMISS")
      @NotNull
  ...
  public RGISResponse bblRegistrationId(String bblRegistrationId) {
   ...
   **/
  @Schema(example = "000002101044", description = "")
      @NotNull
  ...
  public RGISResponse itmxRegistrationId(String itmxRegistrationId) {
   ...
   **/
  @Schema(example = "100187355772", description = "")
      @NotNull
  ...
  public RGISResponse itmxResponse(String itmxResponse) {
   ...
   * @return itmxResponse
   **/
  @Schema(example = "000", description = "")
      @NotNull
  ...
  public boolean equals(Object o) {
    ...
    RGISResponse rgISResponse = (RGISResponse) o;
    return Objects.equals(this.returnCode, rgISResponse.returnCode) &&
        Objects.equals(this.anyIdNo, rgISResponse.anyIdNo) &&
        Objects.equals(this.referenceNo, rgISResponse.referenceNo) &&
        Objects.equals(this.date, rgISResponse.date) &&
        Objects.equals(this.time, rgISResponse.time) &&
        Objects.equals(this.bblRegistrationId, rgISResponse.bblRegistrationId) &&
        Objects.equals(this.itmxRegistrationId, rgISResponse.itmxRegistrationId) &&
        Objects.equals(this.itmxResponse, rgISResponse.itmxResponse);
  }

  @Override
  public int hashCode() {
    return Objects.hash(returnCode, anyIdNo, referenceNo, date, time, bblRegistrationId, itmxRegistrationId, itmxResponse);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RGISResponse {\n");
